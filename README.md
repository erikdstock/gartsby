...
- [ ] Upgrade palette - type-checking will fail until then due to
      styled-components dependencies expecting v3 names
- [ ] Set up gatsby-plugin-graphql to talk to metaphysics
- [ ] Set up
      `gatsby-plugin-remark`/[`gatsby-plugin-mdx`](https://github.com/ChristopherBiscardi/gatsby-mdx)
- [ ] Authentication
